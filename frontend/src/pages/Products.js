...
import mintedNftsList from '../mint_list.json';
import mintedNftsListDev from '../mint_list_devnet.json';
...
export default function Products() {
  ...
  const nftNameValidate = (mintAddress) => {
